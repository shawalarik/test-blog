---
date: 2025-05-11 12:31:32
title: 全局问候提示
permalink: /teekaaa/teek/pages/6ba496
categories:
  - Teek
coverImg: /blogCover/05.webp
description: >-
  基于在 VitePress 主题中实现全局问候提示,基于 Vue 3 组合式 API
  开发，通过useRoute监听路由变化，结合当前时间（小时分段）生成不同问候语（如早安、午安等），使用vitepress-theme-teek的TkMessage.info弹出提示，设置
