---
date: 2025-05-11 07:48:13
title: 运行时间统计
permalink: /teekaaa/teek/pages/83ed27
categories:
  - Teek
description: >-
  基于在 Vitepress 主题中实现页脚运行时间统计功能。基于 useRuntime 组合式函数进行时间差计算；动态更新 DOM
  元素展示天/时/分/秒；通过 watch 监听路由控制计时器启停
top: true
sticky: 4
...
在`docs\.vitepress\theme\hooks`目录下新建`useRuntime.ts`文件
...
详情查看`FooterInfo`配置项：[FooterInfo](/pages/b09547)
