---
date: 2025-04-17 14:57:13
title: 自定义404
permalink: /teekaaa/teek/pages/0af98f
titleTag: 原创
categories:
  - Teek
...
::: tip 版权声明
本文是在 博主[素的还真](https://juejin.cn/user/2928754705330493/posts) 文章：[VitePress 如何自定义 404 页面的内容？》](https://juejin.cn/post/7474038290216779788?searchId=20250414011044ECD152E18DDFB55D0E97) 基础上增加了自己实践过程的一些细节，转载无需和我联系，但请注明文章来源。如果侵权之处，请联系博主进行删除，谢谢~
:::

## 效果

[请点击访问此页面进行查看](https://vitejs.cn/vitepress/guide/extending-default-theme#layout-slots)
...
// @ts-ignore
import NotFound from "./NotFound.vue"; // 导入404组件  // [!code focus:1]
</script>
