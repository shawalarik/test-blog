---
date: 2025-03-29 00:16:13
title: 搭建导航
permalink: /teekaaa/teek/pages/e01e54
categories:
  - Teek
...
::: details 点击展开 `MNavLink.vue` 和 `MNavLinks.vue`
::: code-group
...
- 然后在`Demo\docs-base\.vitepress\config\Nav.ts` 中配置
  ::: warning 注意
  如果您没有抽离[抽离 config 配置](https://wiki.seasir.top/pages/b09547)，则需要在`config.mts`中配置
  :::
