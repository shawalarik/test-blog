...
title: 全局问候提示
permalink: /pages/6ba496
categories:
  - Teek

coverImg: /home/bg3.webp

description: 基于在 VitePress 主题中实现全局问候提示,基于 Vue 3 组合式 API 开发，通过useRoute监听路由变化，结合当前时间（小时分段）生成不同问候语（如早安、午安等），使用vitepress-theme-teek的TkMessage.info弹出提示，设置 4 秒显示时长并通过watch实现路由切换时即时触发问候逻辑。
top: true #是否置顶
sticky: 2 #置顶权重
---
