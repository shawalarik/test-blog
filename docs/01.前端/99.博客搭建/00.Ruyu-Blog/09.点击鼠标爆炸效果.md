---
date: 2025-06-21 19:03:57
title: 点击鼠标爆炸效果
permalink: /front/blog/pages/680bab
categories:
  - 笔记专栏
  - 博客搭建
  - Ruyu-Blog
...
!(function () {
  ...
  if (
    ...
    !(function () {
      (n = this),
        (e = function () {
          ...
          function s(n, e) {
            var t = c(n),
              i = a(u.und(t[0]) ? 1 : t[0], 0.1, 100),
              o = a(u.und(t[1]) ? 100 : t[1], 0.1, 100),
              s = a(u.und(t[2]) ? 10 : t[2], 0.1, 100),
              l = a(u.und(t[3]) ? 0 : t[3], 0.1, 100),
              f = Math.sqrt(o / i),
              d = s / (2 * Math.sqrt(o * i)),
            ...
            p = (function () {
              ...
              return function (t, r, a, u) {
                if (0 <= t && t <= 1 && 0 <= a && a <= 1) {
                  ...
                  if (t !== r || a !== u)
                    for (var s = 0; s < n; ++s) c[s] = i(s * e, t, a);
                  return function (n) {
                    return (t === r && a === u) || 0 === n || 1 === n
                      ? n
                      : i(l(n), r, u);
                  };
                }
          ...
          function P(n, e) {
            var t = x(n);
            for (var r in e) t[r] = u.und(n[r]) ? e[r] : n[r];
            return t;
          }
          function k(n) {
            return u.rgb(n)
          ...
          function B(n, e, t) {
            if (w([t, "deg", "rad", "turn"], C(e))) return e;
            var a = r.CSS[e + t];
            if (!u.und(a)) return a;
          ...
          function F(n, e, t) {
            if (e in n.style) {
              var r = e.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase(),
                a =
                  n.style[e] || getComputedStyle(n).getPropertyValue(r) || "0";
              return t ? B(n, a, t) : a;
            }
          }
          function A(n, e) {
            return u.dom(n) &&
              !u.inp(n) &&
              (!u.nil(I(n, e)) || (u.svg(n) && n[e]))
              ? "attribute"
              : u.dom(n) && w(t, e)
              ? "transform"
              : u.dom(n) && "transform" !== e && F(n, e)
              ? "css"
              : null != n[e]
              ? "object"
              : void 0;
          ...
          function T(n, e, t, r) {
            var a,
              ...
              u = D(n).get(e) || o;
            return (
              t && (t.transforms.list.set(e, u), (t.transforms.last = e)),
              r ? B(n, u, r) : u
            );
          }
          function E(n, e, t, r) {
          ...
          function Y(n, e) {
            var t = x(e);
            if (
              (/^spring/.test(t.easing) && (t.duration = s(t.easing)), u.arr(n))
            ) {
              var r = n.length;
              2 !== r || u.obj(n[0])
                ? u.fnc(e.duration) || (t.duration = e.duration / r)
                : (n = { value: n });
            }
            var a = u.arr(n) ? n : [n];
            return a
              .map(function (n, t) {
                var r = u.obj(n) && !u.pth(n) ? n : { value: n };
                return (
                  u.und(r.delay) && (r.delay = t ? 0 : e.delay),
                  u.und(r.endDelay) &&
          ...
          function G(n, e) {
            ...
            e))
              u.key(a) && t.push({ name: a, tweens: Y(e[a], n) });
            return t;
          }
          function R(n, e) {
            var t;
            ...
            U = (function () {
              ...
              function e(t) {
                for (var r = K.length, a = 0; a < r; ) {
                  var i = K[a];
                  i.paused ? (K.splice(a, 1), r--) : (i.tick(t), a++);
                }
          ...
          function en(t) {
            ...
            function x() {
              var n = w.direction;
              "alternate" !== n &&
                (w.direction = "normal" !== n ? "normal" : "reverse"),
            ...
            function C() {
              (i = 0), (o = k(w.currentTime) * (1 / en.speed));
            }
            function O(n, e) {
            ...
            function I(n) {
              for (var e = 0, t = w.animations, r = t.length; e < r; ) {
                ...
                for (
                  var l = a(n - s.start - s.delay, 0, s.duration) / s.duration,
                  ...
                  (b = s.isPath
                    ? H(s.value, f * x, s.isPathTargetInsideSVG)
                    : M + f * (x - M)),
            ...
            function F(n) {
              ...
              (w.progress = a((d / e) * 100, 0, 100)),
                ...
                r &&
                  (function (n) {
                    if (w.reversePlayback) for (var e = c; e--; ) O(n, r[e]);
                    else for (var t = 0; t < c; t++) O(n, r[t]);
                  })(d),
                !w.began && w.currentTime > 0 && ((w.began = !0), B("begin")),
                !w.loopBegan &&
                  w.currentTime > 0 &&
                  ((w.loopBegan = !0), B("loopBegin")),
                  ...
                  w.remaining
                    ...
                    : ((w.paused = !0),
                      w.completed ||
                        ...
                        B("loopComplete"),
                        B("complete"),
                        !w.passThrough && "Promise" in window && (s(), l(w)))));
            }
            return (
              l(w),
              (w.reset = function () {
                ...
                (w.passThrough = !1),
                  ...
                  (w.remaining = w.loop),
                  (r = w.children);
                for (var e = (c = r.length); e--; ) w.children[e].reset();
                ((w.reversed && !0 !== w.loop) ||
                  ("alternate" === n && 1 === w.loop)) &&
                  w.remaining++,
          ...
          function rn(n, e) {
            ...
            for (var a = r.length; a--; ) {
              var i = r[a],
                o = i.animations;
              tn(n, o), o.length || i.children.length || r.splice(a, 1);
            }
          ...
          return (
            ...
            (en.remove = function (n) {
              for (var e = $(n), t = K.length; t--; ) rn(e, K[t]);
            }),
            (en.get = E),
            (en.set = z),
            (en.convertPx = B),
            ...
            (en.stagger = function (n, e) {
              ...
              return function (n, e, u) {
                ...
                return (
                  m + (f ? (p - d) / y : d) * (Math.round(100 * v[e]) / 100) + h
                );
              };
            }),
      ...
      o = (function (n, e, t) {
        ...
        return function () {
          const a = this,
            i = arguments,
            o = function () {
              (r = null), t || n.apply(a, i);
            },
            u = t && !r;
          clearTimeout(r), (r = setTimeout(o, e)), u && n.apply(a, i);
        };
      })(function () {
    ...
    document.addEventListener(
      ...
      function (i) {
        "sidebar" !== i.target.id &&
          "toggle-sidebar" !== i.target.id &&
          "A" !== i.target.nodeName &&
          "IMG" !== i.target.nodeName &&
          (u.play(),
          (function (e) {
            (r =
              ...
              (a =
                e.clientY ||
                e.touches[0].clientY - n.getBoundingClientRect().top);
          })(i),
          (function (n, r) {
            for (
              var a = (function (n, t) {
  ...
  function c(n, t) {
    ...
    return (
      ...
      (r.endPos = (function (n) {
        ...
        return { x: n.x + r * Math.cos(e), y: n.y + r * Math.sin(e) };
      })(r)),
      (r.draw = function () {
        e.beginPath(),
          e.arc(r.x, r.y, r.radius, 0, 2 * Math.PI, !0),
...
```js
<!--  鼠标点击爆炸效果🎉 -->
<canvas class="fireworks" style="position: fixed; top: 0px; left: 0px; pointer-events: none; z-index: 9999999;"></canvas>
<script src="https://mclick.netlify.app/fireworks.min.js"></script>
```
