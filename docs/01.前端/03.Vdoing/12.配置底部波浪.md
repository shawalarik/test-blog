---
title: 配置底部波浪
date: 2025-03-06 11:53:32
permalink: /front/vdoing/ff295b
...
在`docs/.vuepress/components/`路径创建`Bolang.vue`组件，添加以下代码
::: details
...
<script setup>
// 如果这里有 JavaScript 逻辑，可以添加在这里
// 目前原代码中没有 JavaScript 逻辑，所以此部分为空
</script>
...
- 在`docs\.vuepress\config\plugins.ts`注册组件
