---
date: 2025-05-20 09:25:59
title: 批量生成封面
coverImg: /blogImg/03.webp
permalink: /pages/5a7b31
categories:
  - Teek
description: >-
  在使用 VitePress 构建文档站点时，手动为每篇 Markdown 文章编写
  Frontmatter（如封面）会增加重复工作量。通过开发或集成插件，可实现根据文件内容、文件名或预设规则自动生成 Markdown
  文章的封面，尤其适合批量导入旧文档或标准化内容结构的场景
---
