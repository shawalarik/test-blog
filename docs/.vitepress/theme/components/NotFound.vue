...
const contactMe = () => {
    window.location.href = 'mailto:seasir666@gmail.com';
};
</script>
...
<template>
    <div>
        <!-- about -->
        <div class="about">
            <a class="bg_links social portfolio" href="https://haiyongcsdn.gitee.io/" target="_blank">
                <span class="icon"></span>
            </a>
            <a class="bg_links social dribbble" href="https://dribbble.com/rafaelalucas" target="_blank">
                <span class="icon"></span>
            </a>
            <a class="bg_links social linkedin" href="https://www.linkedin.com/in/wang-hao-666544204/" target="_blank">
                <span class="icon"></span>
            </a>
        ...
        <nav>
            <div class="menu">
                <p class="website_name"><a href="/">首页</a></p>
                <div class="menu_links">
                    <a href="https://juejin.cn/post/7474038290216779788?searchId=20250414011044ECD152E18DDFB55D0E97"
                        class="link">自定义404教程</a>
                    <a href="https://juejin.cn/post/6955460636151119902?searchId=2025041401265634C5E8408C802D4F1CA7"
                        class="link">源码</a>
                    <a href="https://juejin.cn/post/7150950812489875469?searchId=2025041401265634C5E8408C802D4F1CA7"
                        class="link">404关灯</a>
                </div>
                <div class="menu_icon">
                    <span class="icon"></span>
