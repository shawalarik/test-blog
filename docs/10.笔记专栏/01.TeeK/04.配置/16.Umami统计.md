...
title: Umami统计
permalink: /pages/84d648
titleTag: 原创
categories:
  - Teek

coverImg: /home/bg1.webp
description: Umami 是一款开源的、注重隐私的网络分析工具，可作为 Google Analytics 的替代方案。它提供对网站流量、用户行为和性能的重要洞察，同时优先考虑数据隐私。与许多传统分析平台不同，Umami 不会收集或存储个人数据，从而避免了使用 cookie 的需求，并且符合 GDPR 和 PECR 标准。Umami 设计轻巧且易于设置，可以自托管，让用户完全控制自己的数据。
top: true #是否置顶
sticky: 5 #置顶权重
---
