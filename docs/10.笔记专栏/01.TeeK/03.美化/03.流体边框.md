---
date: 2025-03-18 18:18:30
title: 流体边框容器
permalink: style-fluidborder
categories:
  - Teek
coverImg: /blogImg/04.webp
---
...
::: tip 版权声明
本文是在 博主[yiov 大佬的 vitepress 中文网](https://vitepress.yiov.top/) 文章：[《样式美化-补充》](https://vitepress.yiov.top/style-fluidborder.html) 基础上增加了自己实践过程的一些细节，转载无需和我联系，但请注明文章来源。如果侵权之处，请联系博主进行删除，谢谢~
:::
...
在 `docs\.vitepress\theme\style` 新建 `custom-block.scss` 文件
...
复制下面代码，粘贴到 `custom-block.scss` 中，感谢 [@Aurorxa](https://github.com/Aurorxa) 提供本次代码

```scss [custom-block.scss]
...
::: video
https://img.seasir.top/2025/05/07/15/14/51/PixPin_2025-05-07_15-13-32_1746602091458.mp4
:::
<fluidborder />
